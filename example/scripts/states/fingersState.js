...
fingersState.update = function () {
	...
	fingersState.fingers.justTouched(0, function () {
		console.log('just touched');
	});

	fingersState.fingers.touching(0, function (_milliseconds) {
		console.log('touching since', _milliseconds);
	});

	fingersState.fingers.released(0, function () {
